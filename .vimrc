...
source ~/.vim_runtime/vimrcs/mswin.vim
behave mswin
" packloadall
...
let s:vim_runtime = expand('<sfile>:p:h')."/.vim_runtime/.."
...
" Line cursor
" :hi CursorLine   cterm=NONE ctermbg=black ctermfg=white guibg=#3E4452 guifg=#f0f0f0
